...
AGENTS_REGISTRY = [
    ...
    {"id": "volunteer_dispatch", "name": "9. Volunteer Dispatch Agent", "desc": "Volunteer safe route order"},
    ...
    {"id": "drone_swarm_orchestrator", "name": "13. Drone Swarm Agent", "desc": "3D search & rescue"},
    {"id": "weather_monitor", "name": "14. Weather Monitor Agent", "desc": "NWS micro-climate forecasting"},
    {"id": "social_media_distress", "name": "15. Social Media Distress Agent", "desc": "NLP NER for SOS tweets"},
    {"id": "satellite_tasking", "name": "16. Satellite Tasking Agent", "desc": "Planet STAC orchestration"},
    {"id": "telecom_mesh", "name": "17. Telecom Mesh Agent", "desc": "COW deployment centrality"},
    {"id": "shelter_capacity", "name": "18. Shelter Capacity Agent", "desc": "Bed capacity allocation"},
    {"id": "infrastructure_risk", "name": "19. Infrastructure Risk Agent", "desc": "Collapse risk modelling"},
    {"id": "damage_verification", "name": "20. Damage Verification Agent", "desc": "NIM VLM severity check"},
    {"id": "supply_logistics", "name": "21. Supply Logistics Agent", "desc": "Helicopter payload routing"},
    {"id": "audit", "name": "22. Audit Agent", "desc": "SQLite execution logger"},
    {"id": "full_pipeline", "name": "⚡ FULL PIPELINE EXECUTION", "desc": "Run all 22 agents in sequence"},
]
...
DEFAULT_PAYLOADS = {
    ...
    "volunteer_dispatch": {"incident_type": "medical"},
    ...
    "drone_swarm_orchestrator": {"drone_count": 4, "target_zone": "Sector Alpha"},
    "weather_monitor": {"lat": 37.7749, "lng": -122.4194},
    "social_media_distress": {"keywords": ["flood", "help", "trapped"]},
    "satellite_tasking": {"lat": 37.77, "lng": -122.41},
    "telecom_mesh": {"use_sample": True},
    "shelter_capacity": {"evacuees": 150},
    "infrastructure_risk": {"use_sample": True},
    "damage_verification": {"use_sample": True},
    "supply_logistics": {"supplies": {"water": 50, "food": 100}},
    "audit": {"limit": 10},
